...
此项目共有 45 个页面，涉及登录、注册、商品展示、购物车、下单等等，是一个完整的流程。一般公司即使是官网的单页面应用都没这么复杂，如果这个项目能实现，相信大部分公司的其他单页面应用也就没多大问题了，即使再复杂，也不会比这个高到哪里去。

我是利用工作之余的时间来做的，项目从布局到完成共用了2个多月的时间，目前项目已经完成，正在进行一些性能的优化。
...
```
git clone https://github.com/chenwenxianga/vue-elm.git  
